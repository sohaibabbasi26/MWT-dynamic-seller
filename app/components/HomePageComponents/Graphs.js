...
const GraphaSection = ({ views, saves }) => {
    ...
    return (
        <>
            <div className="h-[80vh] max-sm:h-auto w-full flex gap-4 px-10 font-redhat max-sm:flex-col  ">
                ...
                <div className="bg-blueBack w-[40%] max-sm:w-auto flex flex-col justify-center items-center rounded-3xl p-[2rem]">
