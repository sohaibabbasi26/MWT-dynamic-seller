        ...
        <>
            <div className="h-[90vh] max-sm:h-auto max-sm:py-4 max-sm:px-5 w-full bg-blueBack p-16 flex justify-between font-redhat max-sm:flex-col max-sm:items-center">
                ...
                <div className="h-full w-[50%] max-sm:w-[100%] flex flex-col gap-[1rem]">
                    <h2 className="text-3xl max-sm:text-center">
                    ...
                    <div className="flex justify-between w-[90%] gap-[1rem] max-sm:flex-col max-sm:w-full">
                        <div className="flex w-full flex-col">
                            ...
                            <input className="px-3 py-2 w-[100%] rounded-lg border-orangeBack border-2 bg-[rgba(255,255,255,0.1)]" value={formData.f_name} />
                        </div>

                        <div className="flex w-full flex-col">
                            <label className="text-xs">Last Name</label>
                            <input className="px-3 py-2 w-[100%] rounded-lg border-orangeBack border-2 bg-[rgba(255,255,255,0.1)]" value={formData.l_name} />
                        </div>
                    </div>
                    ...
                    <div className="flex  justify-between w-[90%] gap-[1rem] max-sm:flex-col max-sm:w-full">
                        <div className="flex w-full flex-col">
                            ...
                            <input className="px-3 py-2 w-[100%] rounded-lg border-orangeBack border-2 bg-[rgba(255,255,255,0.1)]" value={formData.email} />
                        </div>

                        <div className="flex w-full flex-col">
                            <label className="text-xs">Phone Number</label>
                            <input className="px-3 py-2 w-[100%] rounded-lg border-orangeBack border-2 bg-[rgba(255,255,255,0.1)]" value={formData.phone_no} />
                        </div>

                    </div>

                    <p className="text-sm font-redhat flex gap-[0.3rem] max-sm:justify-center max-sm:w-[100%]">
                        I agree to the
